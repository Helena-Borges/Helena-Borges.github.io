...
if (titulo === "Better Call Saul") {
    id = 0;
} else if (titulo === "Breaking Bad") {
    id = 1;
} else if (titulo === "House of Cards") {
    id = 2;
} else if (titulo === "Narcos") {
    id = 3;
} else if (titulo === "Carros") {
    id = 4;
} else if (titulo === "Carros 2") {
    id = 5;
} else if (titulo === "Uma Família da Pesada") {
    id = 6;
} else if (titulo === "Valente") {
    id = 7;
} else if (titulo === "Friends") {
    id = 8;
} else if (titulo === "House") {
    id = 9;
} else if (titulo === "Mãos Talentosas") {
    id = 10;
} else if (titulo === "Família Moderna") {
    id = 11;
} else if (titulo === "Scarface") {
    id = 12;
} else if (titulo === "That '70s Show") {
    id = 13;
} else if (titulo === "Zumbilândia") {
    id = 14;
}
...
dados[id]['generos'].forEach(genero => {
...
dados[id]['elenco'].forEach(elenco => {
    let item = document.createElement("li");
...
if (dados[id]['titulosSemelhantes'] && dados[id]['titulosSemelhantes'].length > 0) {
...
dados[id]['titulosSemelhantes'].forEach(x => {
